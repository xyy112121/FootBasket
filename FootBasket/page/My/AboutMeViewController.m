...
//    376/552
//    width/height
    float heighthnow = SCREEN_WIDTH*552/376;
    UIImageView *imageview = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, heighthnow)];
    imageview.image = LOADIMAGE(@"aboutme", @"png");
