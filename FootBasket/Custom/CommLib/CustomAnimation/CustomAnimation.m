...
+(void)CAshakeanimation:(id)sender
{
    ...
    //设置抖动幅度
    shake.fromValue = [NSNumber numberWithFloat:+0.02];
    shake.toValue = [NSNumber numberWithFloat:-0.02];
    shake.duration = 0.1;
...
+(void)CAPOPSpringAnimation:(id)sender
{
    ...
    sprintAnimation.fromValue = [NSValue valueWithCGPoint:CGPointMake(1.1, 1.10)];
